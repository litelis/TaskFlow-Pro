  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 space-y-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <svg className="w-5 h-5 text-[#76B900]" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 0L1.5 6v12L12 24l10.5-6V6L12 0zm0 2.25l7.5 4.5v9l-7.5 4.5-7.5-4.5v-9l7.5-4.5z"/>
            </svg>
            NVIDIA API Key
          </h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Enter your NVIDIA API Key to enable AI features. Get your FREE key at{' '}
            <a href="https://build.nvidia.com/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">
              build.nvidia.com
            </a>
          </p>
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#76B900] text-white font-semibold py-3 rounded-xl hover:bg-[#5a8f00] transition-colors shadow-lg"
            >
              Save & Enable AI
            </button>
          <p className="text-[10px] text-gray-400 dark:text-gray-500 text-center">
              Your API key is stored locally in your browser. No data is sent to our servers.
            </p>
          </div>
        </div>
